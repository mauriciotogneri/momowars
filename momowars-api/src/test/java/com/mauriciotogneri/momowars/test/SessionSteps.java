...
public class SessionSteps extends BaseSteps
{
    ...
    {
        ApiResult result = loginEndPoint.execute(null, null);
    ...
    {
        ApiResult result = loginEndPoint.execute("name@email.com", "password");
    ...
    {
        ApiResult result = loginEndPoint.execute("mauricio.togneri@gmail.com", "1234");
    ...
    {
        ApiResult result = loginEndPoint.execute("mauricio.togneri@gmail.com", "password");
